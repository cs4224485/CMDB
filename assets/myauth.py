...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    department = models.CharField(verbose_name='部门', max_length=32, default=None, blank=True, null=True)
    # business_unit = models.ManyToManyField(BusinessUnit)
    tel = models.CharField(verbose_name='座机', max_length=32, default=None, blank=True, null=True)
    mobile = models.CharField(verbose_name='手机', max_length=32, default=None, blank=True, null=True)
